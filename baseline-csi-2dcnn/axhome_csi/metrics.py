...
def try_write_confusion_plot(
    ...
    *,
    ...
    """Write a confusion-style heatmap when Matplotlib is available."""
...
def write_evaluation(
    ...
    *,
    ...
    counts_plot_written = try_write_confusion_plot(
    ...
    normalized_plot_written = try_write_confusion_plot(
    ...
    serializable_metrics["confusion_matrix_png_written"] = (
        counts_plot_written and normalized_plot_written
    )
    ...
    _write_confusion_csv(
        output / "confusion_matrix_counts.csv", matrix, class_names
    )
